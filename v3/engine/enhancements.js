/* Optional, opt-in stroke-richness enhancements — brief 02.
   ...
   brief 08; reconfirmed at the brief 17 chalk merge review): in practice it
   was indistinguishable from age fade — both just modulate how much ink a
   stroke reads as having — so it was cut per "build lean", along with the
   per-stroke velocity field and mean-velocity helper that only existed to
   feed it. Age fade is now the only enhancement. */
